...
export default {
  ...
  setup() {
    ...
    const keyVisualLists = [
      {
        name: 'carousel.mainKeyVisual.name[0]', videoSrc: '../assets/videos/MAIN_KV1.mp4', alt: '', text: 'carousel.mainKeyVisual.text[0]', routeName: 'common.more', router: '/about',
      },
      {
        name: 'carousel.mainKeyVisual.name[1]', backgroundSrc: '../assets/images/svg/home-panel-2.svg' , alt: '', text: 'carousel.mainKeyVisual.text[1]', routeName: 'common.more', router: '/home',
      },
      {
        name: 'carousel.mainKeyVisual.name[2]', backgroundSrc: '../assets/images/svg/home-panel-3.svg', alt: '', text: 'carousel.mainKeyVisual.text[2]', routeName: 'common.more', router: '/about',
      },
      {
        name: 'carousel.mainKeyVisual.name[2]', backgroundSrc: '../assets/images/svg/home-panel-4.svg' , alt: '', text: 'carousel.mainKeyVisual.text[2]', routeName: 'common.more', router: '/home',
      }
    ];
    const cardLists = [
      {
    ...
    return {
      t, keyVisualSwiperOptions, cardSwiperOptions, keyVisualLists, cardLists,
    };
  },
};
</script>
